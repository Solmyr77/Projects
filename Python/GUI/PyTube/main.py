...
set_file_path_button = Button(root, text='Set Save Path', command=start_file_thread)
set_url_button = Button(root, text='Set link', command=start_url_thread)
set_itag_button = Button(root, text="Set itag", command=start_itag_thread)
