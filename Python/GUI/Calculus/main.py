...
button_add = Button(root, text="+", padx=39, pady=20, command=Calculator.button_add)
button_equal = Button(root, text="=", padx=88, pady=20, command=Calculator.button_equal)
button_clear = Button(root, text="Clear", padx=78, pady=20, command=Calculator.button_clear)

button_subtract = Button(root, text="-", padx=40, pady=20, command=Calculator.button_subtract)
button_multiply = Button(root, text="*", padx=40, pady=20, command=Calculator.button_multiply)
button_divide = Button(root, text="/", padx=40, pady=20, command=Calculator.button_divide)
